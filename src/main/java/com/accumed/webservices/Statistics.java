...
public class Statistics {
    ...
    static {
        ...
        requestsCount = 0;
        claimsCount = 0;
        exceptionsList = new ArrayList<DatedException>();
...
//    }
    ...
    public static Double getAverageRequestPerMinute(int period) {
        ...
        Integer local_requestsCount = new Integer(0);
        ...
        switch (period) {
            case 0: {
                ...
                if (rs != null) {
                    local_requestsCount = new Integer(rs.get(0).get(0));
                }
                minutes = 1;
        ...
        if (minutes > 0 && local_requestsCount != null) {
            Double d = new Double((double) local_requestsCount / (double) minutes);
    ...
    public static Double getAverageClaimsPerMinute(int period) {
        ...
        if (minutes > 0 && local_requestsCount != null) {
            Double f = new Double((double) local_requestsCount / (double) minutes);
...
//        }
    ...
    public static Double getAverageClaimValidationTime() {
        ...
        Double ret;
        ret = new Double((double) totalRequestTakenTime / (double) totalClaims);
...
//            return (new Integer(((String) attributes.get("USER_ID")).trim()));
//        }
//        return null;
//
//    }
