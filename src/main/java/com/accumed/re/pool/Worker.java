...
public class Worker {
    ...
    //14/May/2019 smutlak   remove --> , "ICDExclusion"
     ...
     private static final String[] MNEC_CODING_FACTS = {
        "Clinicians", "ClinicianCategories", "Facilities", "Payers", "CodeGroups", "NaCptsDos","FacilityCodeSchema","AAPC_NCCI_CPTS_List",
         "IncompatibleCodesList","ICDExclusionMaster","ICDContradictories","AddOnCodes" ,"ICDAcuteChronic","ICD10_AdditionalCodes"};
...
//        if (repo == null || !repo.isValid()) {
        ...
        try {
            for (String pkg : PACKAGES) {
                ...
                java.lang.reflect.Method method = Worker.class.getMethod("get" + pkg.toUpperCase() + "_FACTS");
                Logger.getLogger(
    ...
    public com.accumed.model.scrubRequest.ScrubRequest validate(
            com.accumed.model.scrubRequest.ScrubRequest req, DB query_db, boolean excludeDBRules, boolean debug)
            throws Exception {
