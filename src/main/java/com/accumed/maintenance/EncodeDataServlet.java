 ...
 * @author Anas
 */
@WebServlet("/maintenance/EncodeDataServlet")
public class EncodeDataServlet extends HttpServlet {
                ...
                while (fileItemsIterator.hasNext()) {
                    ...
                    if (file.exists()) {
                        ...
                        try {
                            ...
                            Logger.getLogger(EncodeDataServlet.class.getName()).log(Level.SEVERE, null, ex);
    ...
    void dbLog(HttpServletRequest request, String filename, HttpServletResponse response
        ...
        try {
            ...
            if (affectedRows == 0) {
                Logger.getLogger(EncodeDataServlet.class.getName()).log(Level.SEVERE, null, new java.sql.SQLException("Creation failed."));
            }
    ...
    private Connection getAccumedDB() {
        ...
        try {
            ...
            if (con.getTransactionIsolation() != Connection.TRANSACTION_READ_UNCOMMITTED) {
                Logger.getLogger(EncodeDataServlet.class
