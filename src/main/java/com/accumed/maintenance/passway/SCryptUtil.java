...
import   com.accumed.maintenance.passway.Base64;
...
public class SCryptUtil {
    ...
    public static String scrypt(String passwd, int N, int r, int p) {
        try {
            ...
            sb.append(com.accumed.maintenance.passway.Base64.encode(salt)).append('$');
            sb.append(com.accumed.maintenance.passway.Base64.encode(derived));
    ...
    public static boolean check(String passwd, String hashed) {
        try {
            ...
            byte[] salt = com.accumed.maintenance.passway.Base64.decode(parts[3].toCharArray());
            byte[] derived0 = com.accumed.maintenance.passway.Base64.decode(parts[4].toCharArray());
